...
export const metadata: Metadata = {
  ...
  description: "Professional financial intelligence dashboard for compliance officers. Bloomberg Terminal-inspired interface with AI-powered insights.",
};
  ...
  return (
    <html lang="en" className={`${jetbrainsMono.variable} ${ibmPlexSans.variable}`}>
      <body className="font-sans antialiased">
        <AlertNotificationProvider simulateAlerts={true} simulationIntervalMs={45000}>
