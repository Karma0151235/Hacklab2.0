      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-80 pl-10 pr-4 py-2 bg-[var(--color-bg-primary)] border border-[var(--color-border-primary)] rounded-lg text-sm text-[var(--color-text-primary)] placeholder:text-text-tertiary focus:outline-none focus:border-[var(--color-accent-primary)] transition-colors"
          />
        </div>
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-[var(--color-border-primary)]">
          <div className="text-right">
            ...
            <div className="text-xs text-text-secondary">AmBank Malaysia</div>
          </div>
