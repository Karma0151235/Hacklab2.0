            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-text-tertiary">
                  {isComplete
                    ? "Completed"
                    : `Processing with ${totalCount} agents`}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
                  ...
                  <div className="relative">
                    ...
                    <div className="grid grid-cols-4 gap-3 mt-8">
                      ...
                      <WorkflowNode
                        ...
                        isActive={activeStep?.id === "sentiment"}
                        compact
                      />
                    </div>
                  </div>
...
function WorkflowNode({
  ...
  const getStatusColor = () => {
    ...
    if (step.status === "running")
      return "border-accent-primary/60 bg-accent-primary/5";
  ...
  const getIconColor = () => {
    ...
    if (step.id === "alert") return "bg-amber-500/15 text-amber-400";
  ...
  const getLabel = () => {
    ...
    if (step.id === "alert") return "Risk Assessment";
  ...
  const getGlowAnimation = () => {
    ...
    if (step.id === "sentiment") {
      return {
        boxShadow: [
          "0 0 15px rgba(20,184,166,0.3), 0 0 30px rgba(20,184,166,0.15)",
          "0 0 25px rgba(20,184,166,0.6), 0 0 50px rgba(20,184,166,0.3)",
          "0 0 15px rgba(20,184,166,0.3), 0 0 30px rgba(20,184,166,0.15)",
        ],
      };
    }
